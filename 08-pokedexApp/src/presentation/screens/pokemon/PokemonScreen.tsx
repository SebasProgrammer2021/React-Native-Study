  ...
  return (
    <ScrollView
      ...
      <FlatList
        ...
        showsHorizontalScrollIndicator={false}
        renderItem={({ item }) => (
          <Chip selectedColor='white' textStyle={{ fontSize: 20 }}>{Formatter.capitalize(item)}</Chip>
        )}
      />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ alignItems: 'center', marginHorizontal: 10 }}>
            <Chip selectedColor='white' textStyle={{ fontSize: 17 }}>
              {Formatter.capitalize(item.name)}
            </Chip>
            <Text style={{ color: "white", fontSize: 17 }}>{item.value}</Text>
          </View>
        )}
      />
      ...
      <FlatList
        ...
        centerContent
        renderItem={({ item }) => (
          <Chip selectedColor='white' textStyle={{ fontSize: 17 }}>{Formatter.capitalize(item)}</Chip>
        )}
      />
