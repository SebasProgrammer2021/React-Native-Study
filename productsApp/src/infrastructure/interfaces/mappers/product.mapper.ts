...
import { ITesloProducts } from "../teslo-products.response";

export class ProductMapper {
  static tesloProductToEntity(tesloProduct: ITesloProducts): IProduct {
    return {
      id: tesloProduct.id,
      ...
      images: tesloProduct.images.map(image => `${API_URL}/files/prodct/${image}`),
    }
  }
}